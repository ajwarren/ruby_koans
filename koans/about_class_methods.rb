...
class AboutClassMethods < Neo::Koan
  ...
  # Me: The former is clearer to me personally so I believe I would use that most often (the method applies to self),
  #     rather than appending the method to the class itself (I'm not sure I really understand this).
  #     Ultimately I'll just follow the convention I'm given.
  # ------------------------------------------------------------------
