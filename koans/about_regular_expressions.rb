...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # ME: By itself it would never fail, but it could be part of a regex that requires a match and then the entire regex would fail.
  end
  ...
  #
  # Why?
  # Me: It will only return the first instance of the specific string indicated, not all matches in the rest of the string unless it fails completely, so it needs to be handled more specifically.
  ...
  # ME: Alternation allows regex to match any one of a set of different text within context of a larger match.
